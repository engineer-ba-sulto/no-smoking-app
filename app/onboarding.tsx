...
export default function OnboardingScreen() {
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      case 1:
        return (
          <Animated.View style={animatedStyle} className="items-center justify-center min-h-[500px] px-5">
            <View className="mb-8">
              <LinearGradient
            ...
            <Text className="text-3xl font-bold text-gray-800 text-center mb-4">ようこそ！</Text>
        ...
        return (
          <Animated.View style={animatedStyle} className="items-center justify-center min-h-[500px] px-5">
            ...
            <View className="w-full my-8">
              <TouchableOpacity
                className={`rounded-xl mb-5 ${startTime === 'now' ? 'shadow-lg' : ''}`}
                onPress={() => setStartTime('now')}
                activeOpacity={0.8}
              >
                <LinearGradient
                  colors={['#10B981', '#059669']}
                  className="py-5 px-8 rounded-xl items-center"
                >
